<g:if test="${pageProperty(name: 'page.filterpane.container')}">
  <g:pageProperty name="page.filterpane.container"/>
</g:if>
<g:else>
  ...
  <!-- Do we still need this hidden prop? -->
    ...
    <table cellspacing="0" cellpadding="0" class="filterPaneTable">
      <g:each in="${fp.properties}" var="propMap">
        <g:if test="${pageProperty(name: 'page.filterpane.property')}">
          <g:pageProperty name="page.filterpane.property"/>
        </g:if>
        <g:else>
    ...
    <g:if test="${fp.showSortPanel == true}">
      <g:if test="${pageProperty(name: 'page.filterpane.sortpanel')}">
        <g:pageProperty name="page.filterpane.sortpanel"/>
      </g:if>
      <g:else>
    ...
    <g:if test="${pageProperty(name: 'page.filterpane.buttons')}">
    <g:pageProperty name="page.filterpane.buttons"/>
    </g:if>
    <g:else>
